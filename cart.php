...
<body>
	...
	<section id="cart_items">
		<div class="container">
			...
			<a href="index.php" class="btn btn-lg btn-primary "><i class="fa fa-shopping-cart"></i> Continue Shopping</a>
		</div>
	</section> <!--/#cart_items-->
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<li>Eco Tax <span>50</span></li>
							<li>Shipping Cost <span>Free</span></li>
							<li>Total <span><?php echo $cartTotal+50;?></span></li>
						</ul>
